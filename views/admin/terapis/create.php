        ...
        <form action="admin.php?page=terapis&action=create" method="POST">
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="namaTerapis" name="namaTerapis" class="form-control" placeholder="Contoh: Sri Wahyuni" required autocomplete="off" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, ''); this.setCustomValidity('')"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="noTelp" name="noTelp" class="form-control" placeholder="Contoh: 0812XXXXXXXX" required autocomplete="off" 
